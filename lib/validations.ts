...
export const serviceItemSchema = z.object({
  ...
  num: optionalSanitizedString(20),
  slug: optionalSanitizedString(100),
  title_en: sanitizedString(2, 200),
  title_ar: sanitizedString(2, 200),
  desc_en: optionalSanitizedString(2500),
  desc_ar: optionalSanitizedString(2500),
  ...
  alt: optionalSanitizedString(200),
