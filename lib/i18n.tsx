...
export const DICTIONARY = {
  en: {
    ...
    impact: {
      ...
      metrics: [
        { value: '50+', label: 'Projects', sub: 'Across Egypt & Saudi Arabia' },
        { value: '1M+ m²', label: 'Designed', sub: 'Precision BIM & Architecture' },
        { value: '4', label: 'Disciplines', sub: 'Architecture · Interior · Landscape · MEP' },
        { value: '3', label: 'Markets', sub: 'Cairo · Riyadh · Middle East' },
      ],
      whereWeWork: {
        index: '07',
        label: 'WHERE WE WORK',
        heading: 'Based in Cairo,\nWorking across Egypt\nand the region.',
        regions: 'EGYPT  /  KSA  /  MIDDLE EAST',
      },
      selectedClients: {
        index: '08',
      ...
      clientFeedback: {
        ...
        quote: '“VIWAN understood the project as a complete experience, not a collection of separate design decisions.”',
  ...
  ar: {
    ...
    impact: {
      index: '06',
      label: 'أثرنا وإنجازنا',
      heading: 'أرقام حقيقية ودقة هندسية موثوقة',
      sub: 'محل ثقة كبار المطورين العقاريين وملاك الفيلات الفاخرة.',
      metrics: [
        { value: '50+', label: 'مشروعاً منجزاً', sub: 'في مصر والمملكة العربية السعودية' },
        { value: '1M+ m²', label: 'تم تصميمه', sub: 'بدقة BIM والتصميم المعماري' },
        { value: '4', label: 'تخصصات متكاملة', sub: 'عمارة · داخلي · لاندسكيب · MEP' },
        { value: '3', label: 'أسواق إقليمية', sub: 'القاهرة · الرياض · الشرق الأوسط' },
      ],
      whereWeWork: {
        index: '07',
        label: 'أين نعمل',
        heading: 'مقرنا في القاهرة،\nونعمل عبر مصر\nوكافة أنحاء المنطقة.',
        regions: 'مصر  /  المملكة العربية السعودية  /  الشرق الأوسط',
      },
      selectedClients: {
        index: '08',
        label: 'شركاء النجاح والعملاء',
      },
      clientFeedback: {
        index: '09',
        label: 'آراء العملاء',
        quote: '“فهمت VIWAN المشروع كتجربة معمارية متكاملة، وليس مجرد مجموعة من القرارات التصميمية المنفصلة.”',
        author: '— عميل إقامة خاصة',
      },
