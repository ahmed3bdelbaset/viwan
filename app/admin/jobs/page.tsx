    ...
    <div className="space-y-8 animate-fade-in pb-12">
      ...
      {isModalOpen && (
        <div
          role="dialog"
          aria-modal="true"
          className="fixed inset-0 bg-black/65 backdrop-blur-md z-[99999] flex items-center justify-center p-3 sm:p-6 overflow-y-auto"
        ...
        >
          ...
          >
            ...
            <div className="flex items-start justify-between border-b border-white/10 pb-4 relative z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="font-cinzel text-xl text-white font-semibold mt-0.5">
            ...
            {/* Form */}
            <form onSubmit={handleSaveJob} className="space-y-5 relative z-10">
              {/* Row 1: Titles */}
              ...
              <div className="flex items-center justify-center gap-3 pt-6 border-t border-white/10 relative z-10">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="px-9 py-3 bg-gradient-to-r from-[#967448] to-[#b38e5d] hover:brightness-110 text-white text-xs sm:text-sm font-semibold tracking-wider rounded-full transition-all shadow-lg shadow-gold/25 active:scale-95 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 min-w-[140px]"
                >
