...
export const WhatsAppIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M9.5 9.5c.3.5.7 1.5 1 2 .5.8 1.2 1.3 2 1.7.5.3 1.2.6 1.7.4.4-.1.7-.6 1-.9" />
  </svg>
);
...
export const BehanceIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
  <span className={`${className} font-bold font-montserrat flex items-center justify-center text-xs tracking-tighter`}>
    Bē
  </span>
);
