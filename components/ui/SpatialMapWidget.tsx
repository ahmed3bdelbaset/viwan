...
const HUBS: CityHub[] = [
  {
    ...
    highlightedProject: 'Zamalek Diplomatic Residence',
    highlightedProjectAr: 'مجمع الزمالك الدبلوماسي',
  },
  {
    id: 'alamein',
    name_en: 'New Alamein',
    ...
    highlightedProject: 'Oasis Residential Complex',
    highlightedProjectAr: 'مجمع الواحة السكني',
  },
  {
    id: 'riyadh',
    ...
    highlightedProject: 'Specialized Hospital KAFD',
    highlightedProjectAr: 'المستشفى التخصصي المالي',
  },
  {
    id: 'jeddah',
    name_en: 'Jeddah Coastal',
    name_ar: 'جدة الكورنيش',
    country_en: 'Saudi Arabia',
    country_ar: 'المملكة العربية السعودية',
    x: 52,
    y: 68,
    projectsCount: 9,
    gfaM2: '74,000 m²',
    activeStatus: 'Red Sea Urbanism',
    highlightedProject: 'Jeddah Commercial Hub',
    highlightedProjectAr: 'مركز جدة التجاري',
  },
  {
    id: 'dubai',
    name_en: 'Dubai Downtown',
    ...
    highlightedProject: 'Skyline Business Tower',
    highlightedProjectAr: 'برج الأعمال البانورامي',
  },
];
